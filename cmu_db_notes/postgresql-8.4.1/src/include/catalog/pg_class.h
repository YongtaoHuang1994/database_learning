...
{
	NameData	relname;		// 数据库对象的名称 /* class name */
	Oid			relnamespace;	// 数据库对象所属名称空间OID /* OID of namespace containing this class */
	Oid			reltype;		// 对象的行类型 对应到pg_type系统表 /* OID of associated entry in pg_type */
	Oid			relowner;		// 对象的所有者 /* class owner */
